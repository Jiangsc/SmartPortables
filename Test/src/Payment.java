...
public class Payment extends HttpServlet {
		...
		HttpSession session=request.getSession();//xnjiade!!!!!!!!!
		...
		if(!userAddress.isEmpty() && !creditCardNo.isEmpty() )
		{
			...
			for (OrderItem oi : utility.getCustomerOrders())
			{
				...
				utility.storePayment(orderId,username,oi.getName(),oi.getPrice(),userAddress,creditCardNo);
			}

			//remove the order details from cart after processing
			
			OrdersHashMap.orders.remove(utility.username());	//utility.username()
