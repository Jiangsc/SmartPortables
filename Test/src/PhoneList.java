...
public class PhoneList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
		   if(CategoryName.equals("IOS"))
		   {
			 for(Map.Entry<String,Phone> entry : SaxParserDataStore.phones.entrySet())
			 {
				if(entry.getValue().getRetailer() != null && entry.getValue().getRetailer().equals("IOS"))
				 {
			...
			for(Map.Entry<String,Phone> entry : SaxParserDataStore.phones.entrySet())
				{
				 if(entry.getValue().getRetailer() != null && entry.getValue().getRetailer().equals("Android"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
...
//
//				pw.print("<li><form method='post' action='Addphone'>"+"<input type='hidden' name='name' value='"+entry.getKey()+"'>"+
//					"<input type='hidden' name='type' value='phones'>"+
//					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
//					"<input type='hidden' name='access' value=''>"+
//				    "<input type='submit' value='Delete' class='btnreview'></form></li>");
//			}
			pw.print("</ul></div></td>");
		...
		if(userType.equalsIgnoreCase("storemanager")) {
			pw.print("<li><form method='get' action='Addphone'>"+"<input type='hidden' name='name' value='abe'>"+
			...
			pw.print("<li><form method='get' action='Deletephone'>"+"<input type='hidden' name='name' value='abe'>"+
