...
@WebServlet("/Delsmartspeaker")

public class Delsmartspeaker extends HttpServlet{
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		while(keys.hasNext()){
			...
			if(id.equals(key)){
				...
				delete = true;
				undelete = false;
				SaxParserDataStore.smartSpeakers.remove(key);
			} 
		}
...
//		}
		...
		pw.print("<form method='post' action='Delsmartspeaker'>"
