...
@WebServlet("/Addsmartspeaker")

public class Addsmartspeaker extends HttpServlet{
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		smartspeaker.setRetailer(maker);
		...
		SaxParserDataStore.smartSpeakers.put(smartspeaker.getId(), smartspeaker);
...
//		}
		...
		pw.print("<form method='post' action='Addsmartspeaker'>"
