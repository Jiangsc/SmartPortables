	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		while(keys.hasNext()){
			...
			if(id.equals(key)){
				...
				delete = true;
				undelete = false;
				SaxParserDataStore.phones.remove( key);
			} 
		}
...
//		}
	...
	protected void displayLogin(HttpServletRequest request, HttpServletResponse response, PrintWriter pw, boolean delete, boolean undelete) //更新在此处修改
...
//		}
		...
		pw.print("<form method='post' action='Deletephone'>"
