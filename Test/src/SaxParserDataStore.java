...
public class SaxParserDataStore extends DefaultHandler {
	...
	public SaxParserDataStore(String phoneXmlFileName) {
    this.phoneXmlFileName = phoneXmlFileName;
   ...
   //parse the xml using sax parser to get the data
    private void parseDocument() 
	{
	    ...
	    parser.parse(phoneXmlFileName, this);
...
////////////////////////////////////////////////////////////
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
		...
		if (element.equalsIgnoreCase("maker")) {
            if(currentElement.equals("phone"))
...
//call the constructor to parse the xml and get product details
 public static void addHashmap() {
		...
		new SaxParserDataStore("/Users/sanchuanjiang/Desktop/ProductCatalog.xml");
    } 
}
