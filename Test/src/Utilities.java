...
public class Utilities extends HttpServlet{
	...
	public String username(){
		if (session.getAttribute("username")!=null)//username
			return session.getAttribute("username").toString();//username
		return null;
	}
	...
	public ArrayList<OrderItem> getCustomerOrders(){
	  ...
	  if(OrdersHashMap.orders.containsKey(username()))//没改之前是username()!!!!!!!
			order= OrdersHashMap.orders.get(username());//没改之前是username()!!!!!!!
	  return order;
	}
	...
	public void storeProduct(String name,String type,String maker, String acc){
		...
		if(type.equals("phones")){
			...
			OrderItem orderitem = new OrderItem(phone.getName(), phone.getPrice(), phone.getRetailer(), phone.getImage());
			orderItems.add(orderitem);
		}
		if(type.equals("wearabletechs")){
			WearableTech wearabletech = null;
		...
		if(type.equals("smartSpeakers")){	
			SmartSpeaker smartSpeaker = SaxParserDataStore.smartSpeakers.get(name); 
