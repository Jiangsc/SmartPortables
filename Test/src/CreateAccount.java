	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else
			{
			    ...
			    FileOutputStream fileOutputStream = new FileOutputStream("\\Users\\sanchuanjiang\\Desktop\\UserDetails.txt");
...
//				session.setAttribute("login_msg", "This account has been created. Please recreate");
				if(!utility.isLoggedin()){
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		if (error)
			...
			pw.print("<form method='post' action='CreateAccount'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><input name='usertype' value='Customer'></input>"
				+ "</td></tr></table>"
