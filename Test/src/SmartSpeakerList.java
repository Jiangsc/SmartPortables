...
public class SmartSpeakerList extends HttpServlet{
	...
	/* SmartSpeakers Page Displays all the SmartSpeakers and their Information in SmartSpeaker Speed */
...
//		  }
		...
		for(Map.Entry<String, SmartSpeaker> entry : hm.entrySet()){
			...
			pw.print("<li id='item'><img src='images/SmartSpeakers/"+SmartSpeaker.getImage()+"' alt='' /></li>");
		...
		if(userType.equalsIgnoreCase("storemanager")) {
			pw.print("<li><form method='get' action='Addsmartspeaker'>"+"<input type='hidden' name='name' value='abe'>"+
			...
			pw.print("<li><form method='get' action='Delsmartspeaker'>"+"<input type='hidden' name='name' value='abe'>"+
